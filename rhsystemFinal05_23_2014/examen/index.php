                    ...
                    <div id="wizard-2" style="margin-left:20px;">
                        ...
                        <section>
                         ...
                         <option value="saab">Femenino</option>
                          ...
                          <select>
                         <option value="volvo">Soltero(a)</option>
                         <option value="saab">Casado(a)</option>
                         <option value="opel">En unión libre</option>
                         </select>
                        ...
                        <section>
                         ...
                         <option value="volvo">Primaria</option>
                          <option value="volvo">Secundaria</option>
                           <option value="volvo">Preparatoria</option>
                            <option value="volvo">Licenciatura</option>
                            ...
                            <label for="userName">Status</label><br>
                                  <select>
                         <option value="volvo">Pasante</option>
                          <option value="volvo">Titulado</option>
                           <option value="volvo">Trunco</option>
                            <option value="volvo">Constancia</option>
                       
                         </select>
                            <br>
                                     <label for="userName">Nivel de Inglés</label><br>
                                  <select>
                         <option value="volvo">Básico</option>
                          <option value="volvo">Intermedio</option>
                           <option value="volvo">Avanzado</option>
                            <option value="volvo">Lengua Materna</option>
...
<div>
                            ...
                            <input id="userName" name="userName" type="text" class="required">
                            <label for="userName">Salario</label>
                            <input id="userName" name="userName" type="text" class="required">
                         ...
                         <option value="volvo">Sí</option>
                            ...
                            <br>
                                                          <select>
                         <option value="volvo">Medio Tiempo</option>
                         <option value="volvo">Tiempo Completo</option>
